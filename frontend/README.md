...
Screens: public Home / Login / Register; signed-in Dashboard, Profile, Scan (`/detect`), and placeholder Recommend / Tracking / Progress. Architecture: `docs/architecture/FRONTEND.md`. Predict API is ticket 004 (`POST /api/v1/food/predict`).
